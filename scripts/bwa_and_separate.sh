...
bwa mem ${path}/spades_result_unique_new/assembly.fasta ${path}/${r1} ${path}/${r2} | samtools view -q 20 -bS -f 2 -F 256 > ${path}/spades_result_unique_new/full_contig_blast.bam 
